...
🔹 [CEIP: Combining Explicit and Implicit Priors for Reinforcement Learning with Demonstrations](https://arxiv.org/pdf/2210.09496.pdf) :+1: 
...
🔹 [Planning for Sample Efficient Imitation Learning](https://arxiv.org/pdf/2210.09598.pdf) :fire: :fire: 
...
🔹 [Robust Imitation via Mirror Descent Inverse Reinforcement Learning](https://arxiv.org/pdf/2210.11201.pdf) 

MD-AIRL: 

🔹 [Learning and Retrieval from Prior Data for Skill-based Imitation Learning](https://arxiv.org/pdf/2210.11435.pdf) :fire: 
...
🔹 [Best Possible Q-Learning](https://arxiv.org/pdf/2302.01188.pdf) 🌋 
...
🔹 [Language to Rewards for Robotic Skill Synthesis](https://arxiv.org/pdf/2306.08647.pdf) :fire: 🌋 :boom: 
...
🔹 [Code as Policies: Language Model Programs for Embodied Control](https://arxiv.org/pdf/2209.07753.pdf) :fire: 
...
🔹 [“No, to the Right” – Online Language Corrections for Robotic Manipulation via Shared Autonomy](https://arxiv.org/pdf/2301.02555.pdf) 😶 

Language-Informed Latent Actions with Corrections (LILAC) 

🔹 [Lila: Language-informed latent actions](https://arxiv.org/pdf/2111.03205.pdf) :fire: 

LILA learns to use language to modulate this controller, providing users with a language-informed control space: given an instruction like “place the cereal bowl on the tray,” LILA may learn a 2-DoF space where one dimension controls the distance from the robot’s end-effector to the bowl, and the other dimension controls the robot’s end-effector pose relative to the grasp point on the bowl. 
...
- Locomotion
  ...
  🔹 [Barkour: Benchmarking Animal-level Agility with Quadruped Robots](https://arxiv.org/pdf/2305.14654.pdf) 🔥
  ...
  🔹 [LATTE: LAnguage Trajectory TransformEr](https://arxiv.org/pdf/2208.02918.pdf) :fire: 
